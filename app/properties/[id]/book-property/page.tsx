...
export default function PropertyBookingSection() {
  ...
  return (
    ...
    <div className="pt-24 px-4">
      <BookingWidget propertyId={typeof id === "string" ? id : id[0]} price={property?.price} priceId={property?.priceId} success_url="http://localhost:3000/success" cancel_url="http://localhost:3000/cancel"/>
    </div>
  )
}